...
public:
    ...
    void RenderSceneCB() override {
        ...
        PointLight sun[3];
        sun[0].DiffuseIntensity = 0.5f;
        sun[0].Color = glm::vec3{1.0f, 0.0f, 0.0f};
        sun[0].Position = glm::vec3{ sinf(v) * 10, 1.0f, cosf(v)*10};
        sun[0].Attenuation.Linear = 0.1f;

        sun[1].DiffuseIntensity = 0.5f;
        sun[1].Color = glm::vec3(0.0f, 1.0f, 0.0f);
        sun[1].Position = glm::vec3(sinf(vv + 2.1f) * 10, 1.0f, cosf(vv + 2.1f) * 10);
        sun[1].Attenuation.Linear = 0.1f;

        sun[2].DiffuseIntensity = 0.5f;
        sun[2].Color = glm::vec3(0.0f, 0.0f, 1.0f);
        sun[2].Position = glm::vec3(sinf(vv + 4.2f) * 10, 1.0f, cosf(vv + 4.2f) * 10);
        sun[2].Attenuation.Linear = 0.1f;
